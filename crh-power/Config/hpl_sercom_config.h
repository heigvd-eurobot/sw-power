...
#define CONF_SERCOM_1_I2CM_BAUD_BAUDLOW                                                                                \
	(((CONF_GCLK_SERCOM1_CORE_FREQUENCY - (CONF_SERCOM_1_I2CM_BAUD * 10U)                                              \
	   - (CONF_SERCOM_1_I2CM_TRISE * (CONF_SERCOM_1_I2CM_BAUD / 100U) * (CONF_GCLK_SERCOM1_CORE_FREQUENCY / 1000U)     \
	      / 10000U))                                                                                                   \
	      * 10U                                                                                                        \
	  + 5U)                                                                                                            \
	 / (CONF_SERCOM_1_I2CM_BAUD * 10U))
#ifndef CONF_SERCOM_1_I2CM_BAUD_RATE
#if (CONF_SERCOM_1_I2CM_BAUD_BAUDLOW > (0xFF * 2) || CONF_SERCOM_1_I2CM_BAUD_BAUDLOW <= 1)
#warning Failed to generate requested I2C baudrate, please check your settings
